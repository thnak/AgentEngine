...
AppContainer + Job Object + restricted token on Windows, sandbox profile + resource limits on
macOS — per **008-Sandbox-and-Isolation.md §3**. This is the default profile for the code
interpreter and shell (010).
