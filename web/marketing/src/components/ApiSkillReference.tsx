  ...
  return (
    <section className="section" id="skills">
      <div className="container">
          ...
          <RevealItem>
            <div className="section-head" style={{ marginTop: 48, marginBottom: 22 }}>
              ...
              <p>
                ...
                component, no loader. A skill that ships <strong>code</strong> packages as an{" "}
                <code>ae:skill</code> plugin (§3) and inherits the whole trust pipeline: signed,
                capability-declaring, operator-approved, digest-pinned, revocable. Either way,{" "}
                <code>allowed-tools</code> is a <em>request</em> reconciled against the operator's
                grant — the manifest declares, the operator grants, <code>Capabilities&lt;...&gt;</code>{" "}
                enforces (007 §3), exactly as it does for a <code>Tool</code>.
              </p>
            </div>
          </RevealItem>
        </RevealGroup>
        ...
        <RevealGroup>
          <RevealItem>
            <div className="gs-note" style={{ marginTop: 40, borderLeftColor: "var(--accent-pink)" }}>
              <strong>Status: entirely design-only today.</strong> <code>plugin_world::skill</code>{" "}
              exists as an enumerator (<code>plugin.hpp:14</code>), but there is no skill-specific
              manifest shape, no loader, and no runtime — <code>wit/README.md</code> lists{" "}
              <code>ae:skill</code> as <em>"not yet authored"</em>, versus <code>ae:tool</code>,
              which is real. The only code anywhere that touches the skill vocabulary is{" "}
              <code>PromptSkillSummary{"{name, description}"}</code>, a prompt-budget rendering
              struct — not a manifest, not a loader.
              <div style={{ marginTop: 8, display: "flex", gap: 16, flexWrap: "wrap" }}>
                <a href={gh("include/agentengine/plugin/plugin.hpp")} target="_blank" rel="noreferrer" className="api-cite" style={{ borderTop: "none", paddingTop: 0 }}>
                  include/agentengine/plugin/plugin.hpp:14
                </a>
                <a href={gh("009-Plugin-and-Extension-System.md")} target="_blank" rel="noreferrer" className="api-cite" style={{ borderTop: "none", paddingTop: 0 }}>
                  009-Plugin-and-Extension-System.md §8
                </a>
              </div>
            </div>
          </RevealItem>
