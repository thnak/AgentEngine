...
- **Gap 12 (ShellRunner write-quota false denial) is CLOSED, and its own deferred FsRead note is
  folded in and CLOSED too.** `decisions/ADR-040-fs-quota-capability-gate-fix.md` (Judged) confirms
