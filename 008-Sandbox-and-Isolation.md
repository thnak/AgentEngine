...
extraction into `register_agent<A>()`. `decisions/ADR-080-sandbox-backend-registry.md` closes the gap
...
section's §1b already describes, unchanged by this registry (ADR-080 §7).
