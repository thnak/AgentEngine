// Live companion to test_memory_procedural_channel.cpp (decisions/ADR-194-procedural-memory-channel.md).
//
...
int main() {
    ...
    // Rows separate FOUR things a single tainted-vs-untainted contrast confounds (ADR-194 red-team):
