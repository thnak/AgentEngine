...
// decisions/ADR-107-hmac-sha256-linux-parity.md. Portable: this test only calls the two functions
...
// tool.cpp -- all Windows-only until ADR-107) -- no test exercised the primitive itself against a
...
int main() {
    ...
    // ---- constant_time_equal() (unchanged by ADR-107, already portable -- proven here too) --------
    {
