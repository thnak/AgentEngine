// Implements decisions/ADR-195-evaluation-harness.md's Tier-1 statistics as real code (round 5):
...
int main() {
    ...
    // ---- Clopper-Pearson bounds: pinned against known values (§6 G1: 1.98% at N=150, x=0) --------
    {
        ...
        // At this extreme (alpha=1e-10, an order of magnitude past anything ADR-195 actually asks
