// Implements decisions/ADR-195-evaluation-harness.md §3.2 / E21's PRECONDITION: is a seeded lesson still
...
// `salience` left at its default 0.0f. Round-2 red-team of ADR-195 read the source and claimed the lesson
