...
// Linux: a from-scratch RFC 2104 construction, decisions/ADR-106-hmac-sha256-linux-parity.md) -- this
...
// decisions/ADR-105-sandbox-tool-provider-composed-linux-parity.md §7, closed by ADR-106), now fixed.
//
