...
// Duplicated from rt::AgentSession's own interaction_to_json/interaction_from_json (agent_session.hpp)
// rather than shared via a common header -- same "small, proven logic, low risk to copy" call this
// file already made for message_codec.hpp's relationship to chat_recording.hpp; a real consolidation
