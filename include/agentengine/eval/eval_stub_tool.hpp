#pragma once
// Implements ADR-181 §3.9's stub-tool requirement ("trial tools are host-authored recording stubs
...
//
// What this file does NOT attempt (ADR-181 §8 residual, named not hidden): the `eval.tool_not_stub`
...
struct StubToolFixture {  // ae-naming-lint: allow StubToolFixture — ADR-181 §3.9
    std::string name;
...
struct CapturedCall {  // ae-naming-lint: allow CapturedCall — ADR-181 §3.9
...
// composed provider, alongside `HistoryProvider` and `MemoryProvider` (ADR-181 §3.2).
class EvalStubToolProvider {  // ae-naming-lint: allow EvalStubToolProvider — ADR-181 §3.9
public:
