#pragma once
// Implements ADR-195 §3.9's `EvalStore` ("the harness is constructed with only an `EvalStore`
...
// mount alone.
//
// What this file does NOT attempt (named here, not silently dropped -- ADR-195 §8 residual): the
...
// A move-only handle: copying would alias two "fresh" stores, defeating the isolation ADR-195
...
class EvalStore {  // ae-naming-lint: allow EvalStore — ADR-195 §3.9
public:
