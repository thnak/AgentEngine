#pragma once
// Implements ADR-195 §3.5's grader requirement ("Programmatic first, and structural. It matches on
...
enum class grade_outcome { success, failure, ungraded };  // ae-naming-lint: allow grade_outcome — ADR-195 §3.5
...
using GraderFn = std::function<grade_outcome(TrialResult const&)>;  // ae-naming-lint: allow GraderFn — ADR-195 §3.5
