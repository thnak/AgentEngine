#pragma once
// Implements ADR-181 §3.9 (round-4 fix, E25's second positive control): trial principals are minted
...
// A production-side guard (ADR-181 §3.9): a principal-construction path outside this file's own
